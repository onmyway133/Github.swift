  ...
  override func spec() {
    ...
    describe("tree") {
      it("should initialize") {
        ...
        expect((entry1.type)).to(equal(TreeEntryType.Blob))
        ...
        expect((entry2.type)).to(equal(TreeEntryType.Tree))
        ...
        expect((entry3.type)).to(equal(TreeEntryType.Commit))
        ...
        expect((entry4.type)).to(equal(TreeEntryType.Blob))
